            ...
            <form onSubmit={handleAccessRequest} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  maxLength={500}
                  rows={3}
                  className="mt-1.5 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:outline-none resize-none"
