...
## Purpose
Integrates Clerk authentication UI with next-intl locale detection for consistent multilingual auth experience.

## Key Deviations from Standard
- Clerk localization configured per-locale in ClerkProvider
...
- French (`fr`): `/fr/sign-in`, `/fr/sign-up`, `/fr/dashboard`
...
### 2. Update AppConfig
```typescript
import { enUS, frFR, deDE } from '@clerk/localizations';
...
export const AppConfig = {
  locales: ['en', 'fr', 'de'], // Add to locales array
  // ...
};
```
