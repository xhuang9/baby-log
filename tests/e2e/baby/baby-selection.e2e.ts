...
test.describe('Baby Selection', () => {
  test.describe('Selection page', () => {
    test.skip('should display baby selection page for multi-baby users', async ({ page }) => {
    ...
    test.skip('should display all accessible babies', async ({ page }) => {
    ...
    test.skip('should select baby and redirect to overview', async ({ page }) => {
      // TODO: Requires authenticated user with multiple babies
      await page.goto('/account/select-baby');
  ...
  test.describe('Baby switcher in app', () => {
    test.skip('should show current baby in header', async ({ page }) => {
    ...
    test.skip('should allow switching babies', async ({ page }) => {
      // TODO: Requires authenticated user with multiple babies
      await page.goto('/overview');
  ...
  test.describe('Edge cases', () => {
    test.skip('should redirect to onboarding if no babies', async ({ page }) => {
    ...
    test.skip('should auto-select if only one baby', async ({ page }) => {
